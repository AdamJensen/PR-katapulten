...
// Set the subject
$mailer->Subject = 'Nyt indhold til bib:nyt lagt på PR-Katapulten';
 
// Body
$mailer->Body = '"Hej
Du bedes behandle nedenstående afsendt via PR-katapulten.
Link til indhold: http://130.227.16.64/pr-katapulten/rediger.php?id='.$lastID.'&init=LHA

Med venlig hilsen
Din venlige MailBot :)';
 
// Add an address to send to.
$mailer->AddAddress('lha@balk.dk', 'Lotte');
